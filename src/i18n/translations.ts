  ...
  uk: {
    ...
    earnings: {
      ...
      data: [
        ...
        { month: "Місяць 6", salary: "$2,500", role: "Developer" },
        { month: "Рік 1", salary: "$4,000", role: "Mid-Level Developer" },
        { month: "Рік 2+", salary: "$6,000+", role: "Senior Developer" },
      ],
    },
    // Process
    process: {
  ...
  ru: {
    ...
    earnings: {
      ...
      data: [
        ...
        { month: "Месяц 6", salary: "$2,500", role: "Developer" },
        { month: "Год 1", salary: "$4,000", role: "Mid-Level Developer" },
        { month: "Год 2+", salary: "$6,000+", role: "Senior Developer" },
      ],
    },
    // Process
    process: {
